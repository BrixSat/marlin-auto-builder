...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  //#define LCD_INFO_MENU   // Disabled to free flash for BLTouch
...
// LCD Print Progress options. Multiple times may be displayed in turn.
   ...
   */
  #define SDCARD_SORT_ALPHA   // Ported from CR-10
  ...
  //#define SCROLL_LONG_FILENAMES           // Disabled to free flash for BLTouch
...
// G2/G3 Arc Support
//
//#define ARC_SUPPORT                   // Requires ~3226 bytes  (disabled to free flash for BLTouch)
...
//#define ADVANCED_PAUSE_FEATURE
  ...
  #define PARK_HEAD_ON_PAUSE                    // Park the nozzle during pause and filament change. (Ported from CR-10)
 ...
 */
//#define EXTENDED_CAPABILITIES_REPORT   // Disabled to free flash for BLTouch
